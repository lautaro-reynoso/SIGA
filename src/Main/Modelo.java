...
public class Modelo {
    ...
    public int InsertarIngreso(String documento, String nombre, String categoria, String dia_ingreso, String dia_egreso, String parsela, float importe, int acomp) {
        String sql = "INSERT INTO ingreso (documento, nombre, categoria ,fecha_ingreso ,fecha_egreso , parsela ,importe, acomp )"
                + "VALUES('" + documento + "','" + nombre + "','" + categoria + "','" + dia_ingreso + "','" + dia_egreso + "','" + parsela + "','" + importe + "','" + acomp + "')";
