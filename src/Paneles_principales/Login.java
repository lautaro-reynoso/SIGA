...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/icon-2.png"))); // NOI18N
        bg.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 60, 390, 210));

        logoname.setBackground(new java.awt.Color(255, 255, 255));
        logoname.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        logoname.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logoname.setText("CAMPING LA FLORIDA");
        bg.add(logoname, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 250, 290, 20));
    ...
    public void Controlar_Logear() {
        Boolean c = null;

        try {
            usuario = userTxt.getText();

            c = controlador.login(usuario, String.valueOf(passTxt.getPassword()));
